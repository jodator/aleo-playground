...
export function MyDebt() {
  ...
  return <div className="text-slate-500 flex">
    <span className="self-center">My public debt: <strong className="text-white">{data ? LeoNumber.fromString(data).value : 0}</strong></span>
  </div>
}